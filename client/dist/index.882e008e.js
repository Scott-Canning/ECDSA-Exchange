...
document.getElementById("generate-wallet").addEventListener('click', ()=>{
    ...
    const request = new Request(`${server}/newWallet`, {
        method: 'POST',
        body
    });
    fetch(request, {
...
document.getElementById("connect-wallet").addEventListener('click', ()=>{
    ...
    const request = new Request(`${server}/balance`, {
        method: 'POST',
        body
    });
    fetch(request, {
...
document.getElementById("transfer-amount").addEventListener('click', ()=>{
    ...
    fetch(request, {
        ...
        let txStatus = "Transaction Failed";
        if (success) txStatus = "Transaction Succeeded";
        document.getElementById("success").innerHTML = txStatus;
...
},{"./index.scss":"fgJeu","elliptic":"1NKsH","../Server/Transaction":"lSvCU","crypto-js/sha256":"cdMuI","../server/Account.js":"8gSNG"}],"fgJeu":[function() {},{}],"1NKsH":[function(require,module,exports) {
'use strict';
...
},{"bn.js":"d0RHy","../utils":"8sNT5"}],"lSvCU":[function(require,module,exports) {
class Transaction {
...
},{}],"cdMuI":[function(require,module,exports) {
...
},{"./core":"547BO"}],"547BO":[function(require,module,exports) {
...
},{"crypto":"jhUEF"}],"8gSNG":[function(require,module,exports) {
class Account {
